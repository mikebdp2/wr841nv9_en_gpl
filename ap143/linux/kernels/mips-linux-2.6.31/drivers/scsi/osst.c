/*
  ...
  $Header: //depot/sw/releases/9.5.3/linux/kernels/mips-linux-2.6.31/drivers/scsi/osst.c#1 $
...
static const char * cvsid = "$Id: //depot/sw/releases/9.5.3/linux/kernels/mips-linux-2.6.31/drivers/scsi/osst.c#1 $";
