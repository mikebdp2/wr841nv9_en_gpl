/* $Id: //depot/sw/releases/9.5.3/linux/kernels/mips-linux-2.6.31/drivers/scsi/aha1542.c#1 $
...
/*
   static const char RCSid[] = "$Header: //depot/sw/releases/9.5.3/linux/kernels/mips-linux-2.6.31/drivers/scsi/aha1542.c#1 $";
 */
