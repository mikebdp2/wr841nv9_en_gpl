...
/* $Id: //depot/sw/releases/9.5.3/linux/kernels/mips-linux-2.6.31/drivers/char/applicom.c#1 $			     */
...
static int __init applicom_init(void)
{
	...
	printk(KERN_INFO "Applicom driver: $Id: //depot/sw/releases/9.5.3/linux/kernels/mips-linux-2.6.31/drivers/char/applicom.c#1 $\n");
