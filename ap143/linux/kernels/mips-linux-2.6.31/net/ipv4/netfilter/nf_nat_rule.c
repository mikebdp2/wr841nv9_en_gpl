...
ipt_snat_target(struct sk_buff *skb, const struct xt_target_param *par)
{
	...
	* use LANy access WAN(setting port), then pkts path will be like follows:
	...
	* but if we have this rule, in normal condition, it will not work correctly, the pkts path will like follows:
	*
