...
ifdef INCLUDE_RUSSIA_DHCP_CLIENT
	CFLAGS += -DINCLUDE_RUSSIA_DHCP_CLIENT
endif

ifeq ($(MODULE_TR069), y)
	CFLAGS += -DMODULE_TR069=1
endif

ifeq ($(MODULE_SMART_DMZ), y)
	CFLAGS += -DMODULE_SMART_DMZ=1
endif

ifeq ($(MODULE_GUEST_NETWORK), y)
	CFLAGS += -DGUESTNETWORK_V1=1
endif

ifeq ($(MODULE_DHCP_REQUEST_SAME_IP),y)
	CFLAGS += -DMODULE_DHCP_REQUEST_SAME_IP=1
endif
