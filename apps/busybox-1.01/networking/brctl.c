...
#ifdef GUESTNETWORK_V1
void br_cmd_setguestnetwork_vap(struct bridge *br, char *ifname, char *arg1)
{
	int cost;
	int ifindex;
	...
	if (!ifindex) {
	 ...
	 br_set_guestnetwork_vap( br, ifindex);
}

void br_cmd_setguestnetwork_state(struct bridge *br, char *arg1)
{
	int cost;
	sscanf(arg1, "%i", &cost);

	br_set_guestnetwork_state(br, cost);
}

void br_cmd_setguestnetwork_mark(struct bridge *br, char *arg1)
{
	unsigned long  cost;
	sscanf(arg1, "%x", &cost);

	br_set_guestnetwork_mark(br, cost);
}
#endif
...
#ifdef GUESTNETWORK_V1
	{1, 1, "setguest_vap", br_cmd_setguestnetwork_vap},
	{1, 1, "setguest_state", br_cmd_setguestnetwork_state},
	{1, 1, "setguest_mark", br_cmd_setguestnetwork_mark},
#endif
};
