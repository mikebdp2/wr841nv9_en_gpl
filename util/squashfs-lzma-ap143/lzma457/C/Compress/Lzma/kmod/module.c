...
/* $Id: //depot/sw/releases/9.5.3/build/squashfs-lzma/lzma457/C/Compress/Lzma/kmod/module.c#1 $ */
...
MODULE_LICENSE("GPL");
MODULE_VERSION("$Id: //depot/sw/releases/9.5.3/build/squashfs-lzma/lzma457/C/Compress/Lzma/kmod/module.c#1 $");
