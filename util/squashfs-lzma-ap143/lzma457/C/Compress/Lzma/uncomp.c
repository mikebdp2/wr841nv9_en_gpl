...
/* $Id: //depot/sw/releases/9.5.3/build/squashfs-lzma/lzma457/C/Compress/Lzma/uncomp.c#1 $ */
...
MODULE_VERSION("$Id: //depot/sw/releases/9.5.3/build/squashfs-lzma/lzma457/C/Compress/Lzma/uncomp.c#1 $");
